...
## Corpus Check
- 79 files · ~119,433 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 961 nodes · 1285 edges · 79 communities (71 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `903158bb`
...
Cohesion: 0.09
Nodes (27): App(), Layout(), Logo(), SplashScreen(), StandardChart(), AuthContext, AuthProvider(), useAuth() (+19 more)
