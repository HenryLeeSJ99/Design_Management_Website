...
## Corpus Check
- 77 files · ~84,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 524 nodes · 1239 edges · 20 communities (17 shown, 3 thin omitted)
...
Cohesion: 0.09
Nodes (35): formatSize(), formatWhen(), Projects(), StatusControl(), VersionHistoryModal(), deleteFromTrash(), deleteProjectFile(), listProjects() (+27 more)
...
Cohesion: 0.08
Nodes (47): clearAllPdfs(), deletePdf(), getPdf(), listPdfIds(), openDb(), putPdf(), run(), readProjectFile() (+39 more)
...
- **Why does `shareReportPdf()` connect `MultiBeamCalculator.jsx` to `SlabFormworkCalculator.jsx`?**
